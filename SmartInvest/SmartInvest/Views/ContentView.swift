...
import SwiftUI
import Supabase
//for checking if a user have been logined , if yes, direct to home page, if not, direct to welcome page
struct ContentView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .userDidAuthenticate)) { _ in
            isAuthenticated = true   // Fresh login , go to switch to MainTabView
        }
    }
