import SwiftUI
//this is a single predictor ai model card , beetter structure with seprate scriot
struct PredictorCardView: View {
    ...
    var body: some View {
        ...
        // MARK: - Tap Gesture with animation and haptic
        .onTapGesture {
    ...
    private var iconBackgroundColor: Color {
        if isDefaultModel {
            ...
            let pastelColors: [Color] = [
                Color(red: 0.95, green: 0.75, blue: 0.45),  // soft gold color
