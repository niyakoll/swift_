...
import Foundation
import SwiftUI
//landing page for user, see the app feature and animation, can go to signin or sign up
            ...
            ZStack {
                ...
                ScrollView {
                    VStack(spacing: 40) {
                        ...
                        // MARK: - Flipping & Shining Gold Coin icon(animation)
                        ZStack {
                    ...
                    VStack(spacing: 16) {
                        ...
                        NavigationLink(destination: SignUpView()) {
                            Text("Sign Up")
                                ...
                                .background(Color.primaryAccent)  // Blue
                        ...
                        .buttonStyle(PressAnimationStyle())  // ← Adds scale and opacity animation
                        .onTapGesture {
