import SwiftUI
import Charts
import PDFKit  //for exporting summary to pdf
import Supabase
//for showing summary of performance of an ai model ,see the chart and statistic
...
// MARK: - Reusable Summary Row with Icon, better code structure
...
struct PriceChartSection: View {
    ...
    // Sorted and filtered by selected range (oldest to newest)
    ...
    // MARK: - Dynamic Y-Axis Domain with Padding, zoom in the scope for beetter ui
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            Chart {
                ...
                ForEach(filteredAndSortedRecords) { record in
                    LineMark(
                        x: .value("Date", record.parsedDate!),  // Safe non-optional
