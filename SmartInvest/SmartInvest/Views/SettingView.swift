...
struct SettingsView: View {
    ...
    // MARK: - Main Content View (Extracted to fix compiler type-check overload)
    private struct ContentView: View {
        ...
        var body: some View {
            Form {
                ...
                Section(LocalizedStringKey("settings_language_section")) {
                    Picker(LocalizedStringKey("settings_language_section"), selection: $languageManager.selectedLanguage) {
                        Text(LocalizedStringKey("language_english")).tag("en")
                        Text(LocalizedStringKey("language_traditional_chinese")).tag("zh-Hant")
                    }
                    .pickerStyle(.menu)
                }
