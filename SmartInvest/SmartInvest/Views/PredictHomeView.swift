...
struct PredictHomeView: View {
    ...
    @State private var yesterdayClose: Double? = nil  // Optional until fetched
    ...
    // MARK: - Main Content (Extracted to fix compiler overload)
    private struct ContentView: View {
        ...
        let goldPriceHeaderView: AnyView  // We'll pass the header as AnyView
        
        //let onPredictorTap: (PredictorModel) -> Void  // Not needed now, but for future
    ...
    // MARK: - Gold Price Header View (Now Simplified!)
