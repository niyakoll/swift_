...
struct PredictorDetailView: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showingEditSheet) {
            ...
            .presentationDetents([.medium])  // Nice half-sheet size
        }
    ...
    @ViewBuilder private func PriceContent() -> some View {
        VStack(spacing: 16) {
            ...
            if isLoadingPrediction {
                ...
                // AI or user has entered a price → show it + allow edit
                Button(action: {
                ...
                // No prediction yet → invite user to enter manually OR use AI
                VStack(spacing: 20) {
    ...
    private func predictFromAPI() async {
        ...
        // 2. Map optimismBias to your mode (feel free to tweak!)
        ...
        // 4. Use the model's API URL (critical for custom models!)
        ...
        request.timeoutInterval = 15  // ← 15 seconds timeout (adjust if needed)
