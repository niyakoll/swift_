import SwiftUI
import Supabase
//show the record card sort bby ai model , allow user to see performance summary
struct RecordView: View {
    @State private var modelRecords: [String: [PredictionRecord]] = [:]  // model_name to records
    ...
    private func loadRecords() async {
        ...
        do {
            ...
            // Create lookup map: date string to close price
...
struct RecordModelCard: View {
    ...
    let onDelete: () -> Void  // caallback to parent
    ...
    var body: some View {
        ZStack(alignment: .topTrailing) {
            ...
            // MARK: Delete Button only for non-default models, user can not delete default ai model
            if modelName != "SmartInvest Default" {
